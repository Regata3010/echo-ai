...
def create_features(
    input_path: str = "../../data/raw/clean_apify_processed.csv",
    output_path: str = "../../data/raw/featurecleaned_apify_processed.csv",
) -> pd.DataFrame:
    try:
        ...
        after = len(df)
        logger.info(f"Removed {before - after} exact duplicate rows during feature engineering")
