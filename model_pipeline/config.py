...
# Data paths
RAW_DATA_PATH = DATA_DIR / 'raw' / 'clean_apify_processed.csv'
PROCESSED_DATA_PATH = DATA_DIR / 'raw' / 'featurecleaned_apify_processed.csv'

# Model paths
# BEST_MODEL_PATH = MODEL_DIR / 'best_model_mac.pkl'
# VECTORIZER_PATH = MODEL_DIR / 'tfidf_vectorizer_mac.pkl'
