...
class EchoAIInference:
    ...
    #prev work was here this is the new predict_Sentiment fn
        ...
        try:
            if self.use_bert:
                ...
                if not self.bert_model:
                    raise ValueError("BERT model not loaded. Call load_models() first.")
                
                return self.bert_model.predict(text)
            
            else:
                # Use TF-IDF model (legacy code)
